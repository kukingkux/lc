-   **1.2.1**
    - Added Config option for dead bodies to only come back once on death and not again
    - Fixed other small bugs
    - Call Glitch a fish for me please thx

-   **1.2.0**
    - Fixed things for v81
    - Sorry Glitch (fish)

-   **1.1.31**
    - Added some raid specific configs
    - I hope I didn't break anything I did this at 8am with no sleep and after doing too much js :D
    
-   **1.1.30**
    - Fixed some small issues (working on bodies doin things still)
    
-   **1.1.29**
    - Fixed Some Twitch integration stuff
    - Potential fix for bodies goin woosh
    - Can someone ask A Glitched NPC - if they are a fish please?
...
-   **1.1.26**
    - Fixed the spawning commands taking a few seconds 
    - Added some Debug stuff

-   **1.1.25**
    - Added configs for Company Moon, Galetry, and Oxyde for spawning things via Twitch Integration
    
-   **1.1.24**
    - Fixed and Added new twitch things for certain people
  
-   **1.1.23**
    - Potential Fixes for twitch chat command not targeting certain names
    - Made a config for masks to not be removed from mimics
    - Fixed some issues (woops my bad)
    
-   **1.1.22**
    - Potential Fixes for a few issues
    - Added a twitch thing
    
-   **1.1.21**
    - Recompiled for v70
    
-   **1.1.20**
    - Possible fix error spam sometimes on revive
    - Possible fix for twitch commands not being able to target people based on length of their ign
    - Updated to Support Twitch Chat API 2.0.0

-   **1.1.19**
    - Possible fix for bodies keep spawning after player was revived and the body isn't disposed of correctly
    
-   **1.1.18**
    - Removed some accidental debug logs that should have already been removed
    
-   **1.1.17**
    - Fixed **_BALD_**
    
-   **1.1.16**
    - Moved the suits to my other mod 
    
-   **1.1.15**
    - Possible Fix for bodies staying
    - Possible fix for zombie mitosis
    
-   **1.1.14**
    - Slight change to spawning things from Twitch 
    
-   **1.1.13**
    - Fixed another similar issue 
    
-   **1.1.12**
    - Fixed an issue with a mask spawning 3 times at once for some reason

-   **1.1.11**
    - Added support for gift subs
    
-   **1.1.10**
    - Fixed Super Cursed Players having a too high of a value (Sorry Glitch and Lunxara lol)
    - Fix for some other things
    
-   **1.1.9**
    - Possible fix for wsm issue
    - Possible fix for NRE for clients
    - Changed the config description to be less confusing for twitch integration blacklist/whitelist
