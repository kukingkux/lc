## 1.2.1
- Fixed crashing upon being fired whenever a default/purchased suit was equipped.
- The mod is still compatible with the game. (v55)
## 1.2.0
- Changed the syncing method used for compatibility with TooManySuits.
<br />
This should reduce the amount of instances where players spawn in with orange suits.
## 1.1.5
