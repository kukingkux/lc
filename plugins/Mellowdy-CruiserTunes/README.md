...
From here you can create or put your .mp3's or .wav's into one of three 'CustomSongs' folders. 
...
***(NOTE: all song files must be .mp3 or .wav files, I recomend that you compress the sound files to reduce memory usage and load times. Additonal note: if the 'CustomSongs' folder does not exist in any of these places you can create one. Make sure it's name is spellt correctly. )***
